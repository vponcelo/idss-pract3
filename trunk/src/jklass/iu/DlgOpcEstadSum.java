...
public class DlgOpcEstadSum extends JDialog {
  Opcions opc;
  ...
  public DlgOpcEstadSum(Frame frame, String title, boolean modal, Opcions opcions) {
  ...
  private void posarOpcions(){
    ...
    taula = opc.obtenirOpcionsEstad(Opcions.ESTAD_SUM);
  ...
  void jBttnOK_actionPerformed(ActionEvent e) {
    ...
    opc.afegirOpcions(Opcions.ESTAD_SUM, taula);
