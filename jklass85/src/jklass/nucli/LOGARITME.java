...
/**
* Classe que representa una l'operació aritmètica logaritme
* És una subclasse de la classe OperacioUnaria
* @author Laia Riera Guerra
* @version v.4 05/05/2007
*/
public class LOGARITME extends OperacioUnaria{
	/**
	 ...
	 */
	public LOGARITME(GestorMatriu m,Object fills,int f){
		super(m,fills,f);		
	}
	/**
	 * Obté el càlcul del logaritme sobre la columna de dades de la matriu <code>alF</code>
	 * @param alF, columna de dades de la matriu corresponent al fill de l'operació
	 * @return llistat de valors corresponents a la columna resultant d'efectuar el càlcul logaritme.
	 * @throws Exception
	 */
	public ArrayList calculaUnari(ArrayList alF)throws Exception{
		...
		for(int j=0;j<alF.size();j++){		
				...
				if(!this.esNumeric(s)){
					...
					Float f=new Float(s);								
					al.add(j,new Float(Math.log10(f.doubleValue())));
			}			
		}			
		return al;	
	}
