...
import jklass.util.OpcionsDis;
 ...
 //DISTANCIES*********************************************************************
 /** Classe que dibuixa el submenu de les opcions de la distància Chi2
 *
 * @author Jose I Mateos
 * @version v.0 11/8/06
 */

public class DlgOpcDistanChi extends JDialog {
  ...
  */
  public DlgOpcDistanChi(Frame frame, String title,boolean modal, OpcionsDis opcions) {
