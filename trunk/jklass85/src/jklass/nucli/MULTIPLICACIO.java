...
/**
 * Classe que representa l'operació  de multiplicació
 * És una subclasse de la classe OperacioBinaria
 * @author Laia Riera Guerra
 * @version v.4 05/05/2007
 */
public class MULTIPLICACIO extends OperacioBinaria {
	/**
	 * Constructor
	 ...
	 * E=3, número
	 */
	public MULTIPLICACIO(GestorMatriu m,Object fillD,Object fillE,int D,int E){
		super(m,fillD,fillE,D,E);
	}
	/**
	 * Efectua el càlcul de multiplicar el fill dret entre el fill esquerra
