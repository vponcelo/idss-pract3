 ...
 * <p>Description: Pantalla que permet realitzar la classificació de la matriu de dades,
 * ja sigui la clàssica segons el mètode de veïns recíprocs encadenats, com la classificació
 * condicionada o la basada en regles.</p>
 * <p>Copyright: Copyright (c) 2006</p>
 * <p> </p>
 * @author Roberto Tuda i Andreu Raya
 * @version v.5
 */
    public class PanelClassificaEst extends JPanel {
	...
	private boolean activas=true;;
      ...
      private static Logger logger = Logger.getLogger(PanelClassifica.class.getName());
	...
	//	private Estado estad;
      ...
      private JPanel jPanelfuera = new JPanel();
   ...
   //private Border border1;
      ...
      private GridLayout gridLayout2Cols = new GridLayout(1,2);
		private GridBagLayout gridLayout2Fils = new GridBagLayout(); //ale el pare es esteeee
   ...
   // private GridLayout gridLayout3Rows = new GridLayout(3,1);//alejandro lo comentó
     // private GridLayout gridLayout3Rows = new GridLayout(4,1);// alejandro lo volvio a comentar
		private GridLayout gridLayout3Rows = new GridLayout(5,1);
   /*private GridLayout gridLayoutEsq = new GridLayout(12,1);
   private GridLayout gridLayoutDret = new GridLayout(12,1); : */
   ...
   //private JComboBox jCmbBMetod = new JComboBox(TpMetodes);
     private ButtonGroup jbgMetode = new ButtonGroup();
      ...
      private JSeparator sepCIPrefixEsq = new JSeparator(SwingConstants.HORIZONTAL);
      private JSeparator sepCIPrefixDret = new JSeparator(SwingConstants.HORIZONTAL);
   
   //private JLabel lEspaiAdalt = new JLabel();
   //private JLabel lEspaiAbaix = new JLabel();
   
   //private JSeparator sepHorCond1 = new JSeparator(SwingConstants.HORIZONTAL);
   //private JSeparator sepHorCond2 = new JSeparator(SwingConstants.HORIZONTAL);
   ...
   //private JSeparator sepVertCond1 = new JSeparator(SwingConstants.VERTICAL);
   //private JSeparator sepVertCond2 = new JSeparator(SwingConstants.VERTICAL);
   /*private JPanel pVertCondicionament1 = new JPanel();
   private JPanel pVertCondicionament2 = new JPanel(); : */
   ...
   /*private JLabel lBConeixement1 = new JLabel();
   private JLabel lBConeixement2 = new JLabel();
   private JSeparator sepHorBCon1 = new JSeparator(SwingConstants.HORIZONTAL);
   private JSeparator sepHorBCon2 = new JSeparator(SwingConstants.HORIZONTAL);
   private JPanel pBConeixement1 = new JPanel();
   private JPanel pBConeixement2 = new JPanel();*/
   ...
   /*private JLabel lSepConeixement = new JLabel();
   private JSeparator sepVertCon1 = new JSeparator(SwingConstants.VERTICAL);
   private JSeparator sepVertCon2 = new JSeparator(SwingConstants.VERTICAL);
   private JPanel pVertConeixement1 = new JPanel();
   private JPanel pVertConeixement2 = new JPanel(); : */
      private JPanel pConeixement = new JPanel();
   
      private JPanel pConeixementale = new JPanel();//alejandro
	   	
   
   /*private JSeparator closeSepEsq = new JSeparator(SwingConstants.HORIZONTAL);
   private JSeparator closeSepDret = new JSeparator(SwingConstants.HORIZONTAL);
   private JPanel closeBCEsq = new JPanel();
   private JPanel closeBCDret = new JPanel();
   */
   ...
   //private JSeparator sepBCYCriteriEsq = new JSeparator(SwingConstants.HORIZONTAL);
   //private JSeparator sepBCYCriteriDret = new JSeparator(SwingConstants.HORIZONTAL);
	 ...
	 public JCheckBox jCBGuardarDisc = new JCheckBox();
	 	JLabel jLblProc = new JLabel();
       	JComboBox jCmbBProc = new JComboBox();
   ...
   */
       public PanelClassificaEst(FrPrincipal fr,GestorKlass gk) {
         frPare = fr;
         gestor = gk;
   ...
   */
      ...
      //frPare.setSize(618, 615);//alejandro cambio tamaño
         ...
         titledBorder1 = new TitledBorder(new EtchedBorder(EtchedBorder.RAISED,Color.white,new Color(156, 156, 158)),"Classificació per Stats");
      
        // this.setSize(680, 815);
		   this.setBorder(titledBorder1);
       //  this.setLayout(borderLayout1); //aleeeee
		 this.setLayout(gridLayout2Fils); //ale aca le digo el GridBagLayout
      ...
      //Pintem el Panell del Mètode, el de dalt
         ...
         jPanelMetode.setBorder(tMetode);
			//jPanelMetode.setBounds(70, 0, 56, 170);
	...
	//	 System.out.println("holaaa entre en activasdefinidas TRUEEEEEEE con largo" + gestor.LenActiveProps());
	//	 }
	//	 else {
	...
	//	  }
     ...
     //    soloactivas.addActionListener(
      //          new java.awt.event.ActionListener() {
       ...
       //        });
         ...
         radioMetodeVRE.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
         ...
         radioMetodeClassCond.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                     gestionarParametritzador();
                  }
         ...
         radioMetodeClassBR.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                     gestionarParametritzador();
                  }
         ...
         radioMetodeClassBRale.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                     gestionarParametritzador();
                  }
     ...
     //    pActivas.add(lEspaiactivas);
         ...
         lEspaiMetode1.setText("                                                                                                   ");
         pVeinsEncadenats.add(lEspaiMetode1);
      
         omplirCombos();
         gestionarParametritzador();
      
         jLblCondicionament.setText("                                                          Variable de condició:  ");
         ...
         jLblBConeixement.setText("                                                   Base de coneixement:");
      ...
      //alejandro
         jLblBConeixementale.setText("                                  Base de coneixement:");
      ...
      //jPanelMetode.setPreferredSize(new Dimension(600, 105));
        // jPanelMetode.setPreferredSize(new Dimension(600, 145));//alejandro
			  ...
			  jPanelMetode.setPreferredSize(new Dimension(650, 155));//alejandro2
      
      //Pintamos el Panel General, el de la izquierda
      
         jPanelGral.setLayout(gridLayout2Cols);
		//	jPanelGral.add(jLblVar);
				jLblVar.setBounds(70, 84, 56, 10);
			 jLblVar.setText("       Stats:");
			 
			 jLblProc.setBounds(70, 84, 56, 10);
			 jLblProc.setText("     Procs:");

			  jCmbBVar.setMinimumSize(new Dimension(26, 21));
	      jCmbBVar.setPreferredSize(new Dimension(66, 21));
	      jCmbBVar.setMaximumRowCount(15);
			
			 jCmbBProc.setMinimumSize(new Dimension(26, 21));
	      jCmbBProc.setPreferredSize(new Dimension(66, 21));
	      jCmbBProc.setMaximumRowCount(15);
         
			String proc=null;
			proc=gestor.obtenerProceso();
			jCmbBProc.addItem((String)proc);			
			 lista = gestor.obtenirLlistaEst();
				//jCmbBVar.addItem("hola");
				Estado esta;
				 
					for(int j=0;j<lista.size();j++){
					esta = (Estado) (lista.get(j));
	 	 jCmbBVar.addItem((String)esta.nom); // para mostrar estados
			
				//modelo.insertElementAt(modsSelec[j],j);
		//	System.out.println( "y esto funcionaa??");
	 		}
 ...
 /*	String sal;
   lista= gestor.matriusCarregades[0].llEstados;
	sal= lista.get(0).nom;*/
	 
 // Estado ar = (Estado) lista.get(0);
	 
 /*	 String nombre;
	  System.out.println("voy a entrar");

	 Estado estam = (Estado) (lista.get(0));
	  System.out.println("voy a salir");

	 nombre = (String) estam.nom;
	 System.out.println("hay algo en nombre?"+nombre);
	 jCmbBVar.addItem(nombre);*/
	 
	 //nombre= lista.get(1).nom;
	// jCmbBVar.addItem(lista.get(0).nom);
    ...
    //     this.add(jRadioButtonLLExplicita);//alejandro
      ...
      //separadorDret.setPreferredSize(new Dimension(100, 1)); :
         ...
         guardarFicheroHis.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
         ...
         guardarFicheroDrm.addActionListener(
                new java.awt.event.ActionListener() {
                   public void actionPerformed(ActionEvent e) {
      ...
      /*jPanelEsq.add(pCondicionament1);
      jPanelEsq.add(jLblCondicionament); : */
      /*jPanelEsq.add(pHorCondicionament1);
      jPanelEsq.add(pVertCondicionament1);
      jPanelEsq.add(pBConeixement1);*/
      //jPanelEsq.add(jLblBConeixement);
      /*jPanelEsq.add(pVertConeixement1);
      jPanelEsq.add(closeBCEsq);*/
      ...
      jPanelDret.add(pVertCondicionament2);
      jPanelDret.add(pBConeixement2);*/
      //jPanelDret.add(jCmbBBConeixement); :
      /*jPanelDret.add(pVertConeixement2);
      jPanelDret.add(closeBCDret);*/
      ...
      //jPanelDret.add(separadorDret); 
         ...
         jPanelGral.setPreferredSize(new Dimension(315, 250));
			jPanelVar.setSize(new Dimension(100, 300));
         jPanelVar.add(jCBGuardarDisc, null);
			 jPanelVar.add(jLblProc, null);
			  jPanelVar.add(jCmbBProc, null);

		   jPanelVar.add(jLblVar, null);
			 jPanelVar.add(jCmbBVar, null);
			// jPanelVar.add(jLblProc, null);

         jCBGuardarDisc.setText("Per Estats");
	  jCBGuardarDisc.setSelected(false);
	  	jCBGuardarDisc.addActionListener(new java.awt.event.ActionListener() {
    	public void actionPerformed(ActionEvent e) {
      		jCBGuardarDisc_actionPerformed(e);
       	}
    });
		 ...
		 // this.add(jPanelVar,BorderLayout.NORTH);
        // this.add(jPanelMetode,BorderLayout.NORTH);//son los métodos de clasificacion
       //  this.add(jPanelGral, BorderLayout.WEST);
       //  this.add(pClasifica, BorderLayout.EAST); //alejandro estas son las distancias
       //  this.add(jPanelBotones,  BorderLayout.SOUTH);
			jPanelfuera.setLayout(gridLayout2Fils);
			//	GridBagLayout jPanel1Layout = new GridBagLayout();
			//this.add(jPanelVar);
			this.add(jPanelVar, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

			this.add(jPanelMetode, new GridBagConstraints(0, 1, 0, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			this.add(jPanelGral, new GridBagConstraints(0, 2, 0, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
        	this.add(pClasifica, new GridBagConstraints(0,2 , 1, 1, 0.0, 0.0, GridBagConstraints.LINE_END, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
			this.add(jPanelBotones, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0)); 	
   ...
   */
	...
	private void jCBGuardarDisc_actionPerformed(ActionEvent e){
	System.out.println( "a ver domi");
	
	 boolean porests;
		  porests = jCBGuardarDisc.isSelected();
		  System.out.println( "como esta por estados"+  porests);
		  ///////////////disparar el evento cuando da clic en el checkbox
		  ///////Pasarle esto al gestor klass cuando da click en elcheckbox
		  //disparar el evento que setea la variable de gestor matriz cuando da click en el checkbox
		  //lo mismo cuando elige el estado
		  
		   
		//////////7	 
		 try {
              gestor.PorEstados(porests);
            }
                catch (Exception ex) {
                  frPare.actualitzarBarraEstat("Hi han hagut problemes per obtenir Stats. (" + ex.getMessage() + ")", true);
               }
   	...
   	private void jCmbBVar_actionPerformed(ActionEvent e){
	System.out.println( "elegi un estado");
	String var=null;
			var = (String)jCmbBVar.getSelectedItem();
			 System.out.println( "cual es la var"+  var);
			 ///
			  try {
              gestor.SetearEstadoActual(var);
            }
                catch (Exception ex) {
                  frPare.actualitzarBarraEstat("Hi han hagut problemes per obtenir Stats. (" + ex.getMessage() + ")", true);
               }
   ...
   /**
   * Funció relacionada amb l'esdeveniment associat al botó de <b>D'Acord</b>, que realitza,doncs,
   * la classificació de la matriu de dades segons els paràmetres introduïts per l'usuari.
   * 
   * @param e esdeveniment
   */
   ...
   */
       ...
       //int llindar = CONDICIONADA.equals((String)jCmbBMetod.getSelectedItem())? 1 : 0; : 
         ...
         switch(opc.getTipus()){
            ...
            case OpcionsDis.ICHINO:
               if (gestor.obtenirMiss()){
                  frPare.actualitzarBarraEstat("En la distància Ichino-Yaguchi,la matriu de dades no pot contenir missings", true);
                  ok=false;
               }
               break;
   ...
   /**
   * Funció associada al esdeveniment de pitjar el botó de <b>D'Acord</b>. Així doncs,
   * després de comprovar la correctesa de totes les dades, es faran les crides pertinents
   *  per a realitzar la classificació sol·licitada
   * 
   * @param e esdeveniment
   */
   ...
   String [] arractivas = new String [activias.size()];
      ...
      //alejandro 
        ...
        //  System.out.println( "ALEEE tengo las activas aca????"+  activas.get(p));
          ...
          System.out.println( "tengoactivas en array????lunes"+  arractivas[p]);
	...
	/*		var = (String)jCmbBVar.getSelectedItem();
			 ...
			 ///
			  try {
              gestor.ObtenirEstadoActual(var);
            }
                catch (Exception ex) {
                  frPare.actualitzarBarraEstat("Hi han hagut problemes per obtenir Stats. (" + ex.getMessage() + ")", true);
               }
      ...
      //metode = (String)jCmbBMetod.getSelectedItem();
         ...
         if (guardarFicheroHis.isSelected()) {
            ...
            if ( (new File(rutaFichero+"/"+archivo1 + ".his").exists()) ) {
               int n = JOptionPane.showConfirmDialog(this,"El fitxer " + archivo1 +".his ja existeix, \n" +
         ...
         if (guardarFicheroDrm.isSelected()) {
            ...
            if ( (new File(rutaFichero+"/"+archivo2 + ".drm").exists()) ) {
               int n = JOptionPane.showConfirmDialog(this,"El fitxer " + archivo2 +".drm ja existeix, \n" +
                                      "¿estàs segur que vols sobrescriure'l?",
                                      "Fitxer ja existeix",JOptionPane.YES_NO_OPTION );
         ...
         //opc=pClasifica.getOpcions();
            if (comprovarDades()) {
               if (opc.getTipus()=='\u0000' ){
                  frPare.actualitzarBarraEstat("S'ha d'elegir un tipus de distancia", true);
               }
               else{
                  if (opc.getCateg()=='\u0000' && (opc.getTipus()==OpcionsDis.EUCLI || opc.getTipus()==OpcionsDis.ABS || opc.getTipus()==OpcionsDis.MINKO || opc.getTipus()==OpcionsDis.MIXTA || opc.getTipus()==OpcionsDis.ICHINO || opc.getTipus()==OpcionsDis.RALAM)){
                     frPare.actualitzarBarraEstat("S'ha d'elegir/omplir les opcions de la distancia seleccionada", true);
                  }
                  else {
                     try {
                     //if (VEINS.equals(metode)) { :
						...
						/*	Obtener todos los estados
							mientras no se terminen los estados
						   	Obtener el primero
							   Obtener variables del estado
						   	Clasificar con esas variables
							   obtener siguiente estado
							fin mientras*/
							/////////////
							Estado esta;
	  
/*if  (gestor.obtenerGM().estadosel){
System.out.println( "entré");
String [] varsest=null;

	for(int j=0;j<gestor.obtenerGM().llEstados.size();j++){
					esta = (Estado) (gestor.obtenerGM().llEstados.get(j)); 
				
					varsest=esta.variables;
				
					for(int p=0;p<varsest.length;p++){
				   	System.out.println( esta.nom+"varest"+varsest[p]);
					}
...
String [] varsest=null;
        	for(int j=0;j<gestor.obtenerGM().llEstados.size();j++){
					...
					for(int p=0;p<varsest.length;p++){
				   	System.out.println( esta.nom+" que hay en varest"+varsest[p]);
					}
            }
							
							///////////////////////
							String est="";
							for(int r=0;r<gestor.obtenerGM().llEstados.size();r++){
							
								esta = (Estado) (gestor.obtenerGM().llEstados.get(r)); 
				         	varsest=esta.variables;
                        est=esta.nom;
							System.out.println("a ver que hay en est"+est);
								  if(clasificada = gestor.classificarMatriuEst(/*metode, */est,varsest,criteri, opc, identificador, tipus, archivo1, archivo2, ficheroHis, ficheroDrm/*, jCBInversionsControl.isSelected()*/)) {

								   // Informar el nom de l'arbre
                           /*String nomArbre = */gestor.informarIdArbreEst("vre", criteri, opc,est);
                              frPare.actualitzarBarraEstat(" Classificació realitzada correctament. ", false);
                              frPare.habilitarOpcionsMenu(true, true);
										}
                            
                           else {
                           //frPare.actualitzarBarraEstat(" No s'ha pogut realitzar la classificació. ", true);
                              frPare.actualitzarBarraEstat(" L'identificador de classe no es correcte. ", true);
                           }
									}//el for termina aca
                        } 
                        else {
                           boolean controlInversions = jCBInversionsControl.isSelected();
                        //if (CONDICIONADA.equals(metode)) { :
                           if (radioMetodeClassCond.isSelected()) {
                              String condicionant = (String)jCmbBCondicionament.getSelectedItem();
                              if (null == condicionant) {
                                 frPare.actualitzarBarraEstat("No es pot fer una classificació basada condicionada si no hi ha cap variable categòrica.", true);
                              } 
                              else if (clasificada = gestor.classificarDivisioBDD(condicionant, criteri, identificador, opc, tipus, controlInversions, archivo1, archivo2, ficheroHis, ficheroDrm)) {
                              // Informar el nom de l'arbre
                              /*String nomArbre = */gestor.informarIdArbre("cc", criteri, opc, condicionant);
                                 frPare.actualitzarBarraEstat(" Classificació realitzada correctament. ", false);
                                 frPare.habilitarOpcionsMenu(true, true);
                              } 
                              else {
                           ...
                           // Exogena
							...
							String pad;	
                                 ...
                                 frPare.actualitzarBarraEstat("No es pot fer una classificació exógena si no hi ha cap variables actives", true);
                              } 
								//	else if ( soloactivas.isSelected()){
                          //       frPare.actualitzarBarraEstat("Se debe hacer con todas", true);
                           //   } 
	
																																								
                      else{
										
										 String bConeixement = (String)jCmbBBConeixementale.getSelectedItem();
                           String condicionant;
									condicionant= gestor.avaluaBCexo(bConeixement, criteri, identificador, opc, tipus, controlInversions, archivo1, archivo2, ficheroHis, ficheroDrm); 
							...
							//	System.out.println("eliminé las props");
									...
									if (null == condicionant) {
                                 frPare.actualitzarBarraEstat("No es pot fer una classificació  condicionada si no hi ha cap variable categòrica.", true);
                              } 
                            ...
                            // System.out.println("sali de la condicioanda de la exogena con clasificada="+clasificada);
                              ...
                              /*String nomArbre = */gestor.informarIdArbre("cc", criteri, opc, condicionant);
                                String nomArbre = gestor.obtenirNomArbre();
										 // System.out.println("con que nom arbre sale"+nomArbre);

										   frPare.actualitzarBarraEstat(" Hice bien la exogena!!!. ", false);
                                 frPare.habilitarOpcionsMenu(true, true);
                              } 
									...
									///////////
                         //  if(lista.size() == 0){                            // Informar el nom de l'arbre
                          // /*String nomArbre = */gestor.informarIdArbre("vre", criteri, opc);
                            //  frPare.actualitzarBarraEstat(" Classificació realitzada correctament. ", false);
                              //frPare.habilitarOpcionsMenu(true, true);
                          // } 
                           else {
                           frPare.actualitzarBarraEstat(" No s'ha pogut realitzar la classificació. ", true);
                              frPare.actualitzarBarraEstat(" L'identificador de classe no es correcte. ", true);
									...
									//System.out.println("termine la exogena con matriuactual"+gestor. obteniractual());
							//	String matriu=" ";
							...
							//	 matriu = gestor.tancaMatriuActual();									
                              ...
                              String bConeixement = (String)jCmbBBConeixement.getSelectedItem();
                              if (null == bConeixement){ 
                                 frPare.actualitzarBarraEstat("No es pot fer una classificació basada en regles si no hi ha cap base de coneixement", true);
                               }
									    if  (null != bConeixement){
										 System.out.println( "hola entre al comprobar");
										  validas=gestor.ComprobarProps(bConeixement,arractivas);
										  
										   for (int p = 0; p < validas.size(); p++) {
    
          System.out.println( "que hay en validas"+  validas.get(p));
         
         }

										  
										  System.out.println( "hola sali del comprobar");

										}  
										 for (int r = 0; r < arractivas.length; r++) {
      //    ordreProps.add(i, propietats.obtenirPropietat(i).obtenirId());
        System.out.println( "tengo las activas en el arrayale????"+  arractivas[r]); 
									...
									//	}
										/////////////////agrego para validar activas
								 if ( validas.size()>0){ 
                                 frPare.actualitzarBarraEstat("Las propiedades de las reglas no estan definidas como activas ", true);
                              }

									
										//////////////fin del agrego
										 
                            else if (clasificada = null != gestor.avaluaBCIClassifica(bConeixement, criteri, identificador, opc, tipus, controlInversions, archivo1, archivo2, ficheroHis, ficheroDrm)) {
                                 frPare.actualitzarBarraEstat(" Classificació realitzada correctament. ", false);
                                 frPare.habilitarOpcionsMenu(true, true);
                              } 
                              else {
                     ...
                     frPare.actualitzarBarraEstat(" L'identificador de classe no es correcte. ", true);
                        ...
                        //ex.printStackTrace();
                           frPare.actualitzarBarraEstat(" Error: " + ex.getLocalizedMessage(), true);
         ...
         if (visualizar.isSelected() && clasificada) {
            ...
            try {
               ok = gestor.visualitzaArbre();
                  ...
                  frPare.actualitzarBarraEstat("Hi han hagut problemes per visualitzar el dendograma. (" + ex.getMessage() + ")", true);
               }
         
            if (ok) {
				String nomRes=null;
              // String nomRes = new File(frPare.obtenirNomDades()).getName();ale sabado
				  try{
               ...
               frPare.actualitzarBarraEstat("S'ha realitzat la visualització del dendograma correctament. (Resultats al fitxer: " + nomRes + "InfAuto.tex)", false);
               try {
                     ...
                     // output?
                        ...
                        if (err == 0) {
                          ...
                          // System.out.println("error debe valer distinto de cero="+err);
                           frPare.actualitzarBarraEstat("ALE4No s'ha pogut compilar correctament el fitxer Latex generat.", true);
                        }
                     }
   ...
   /**
   * Funció que guarda memòria de si l'usuari ha seleccionat guarda els fitxer d'història a disc
   * 
   * @param e esdeveniment
   */
   ...
   /**
   * Funció que guarda memòria de si l'usuari ha seleccionat guarda els fitxer drm a disc
   * 
   * @param e esdeveniment
   */
   ...
   /**
   * Funció que gestiona la disponibilitat i l'estat de selecció per defecte del check de control
   * d'inversions segons el mètode i criteri seleccionats.
   */
   ...
   /**
   * Funció que,segons el mètode seleccionat, activa la caixa de selecció de les 
   * variables categòriques (condicionada) o de les Bases de Coneixement (basada en regles)
   *
   */
...
//	gestor.canviarMatriuActual(1 );
			 System.out.println( " ACtivas true cambie a "+(gestor.obtenirocupadas()-2) );
           ...
           // activarTodas();
			 gestor.canviarMatriuActual(0); 
		//	gestor.canviarMatriuActual(0);
			 System.out.println( "activas false cambie a "+(gestor.obtenirocupadas()-1)  );  
         System.out.println( " que carajo vale la actual en false "+gestor.obteniractual() );
         }
...
*/
	...
	/**
   * Funció encarregada d'omplir les caixes de selecció amb les variables categòriques
   * per al condicionament i la llista de bases de coneixement.
   *
   */
       private void omplirCombos() {
        // String[][] llProps = gestor.obtenirLlistaIDsProps();ale para condicionada
			String[][] llProps;
			 ArrayList activias=new ArrayList();
	  activias= gestor.matriusCarregades[gestor.obteniractual()].obtenirActivas();
