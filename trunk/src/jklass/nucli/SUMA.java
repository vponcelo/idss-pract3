...
/**
 * Classe que representa l'operació  de suma
 * És una subclasse de la classe OperacioBinaria
 * @author Laia Riera Guerra
 * @version v.4 05/05/2007
 */
public class SUMA extends OperacioBinaria {
	/**
	 * Constructor
	 ...
	 * E=3, número
	 */
	public SUMA(GestorMatriu m,Object fillD,Object fillE,int D,int E){
		super(m,fillD,fillE,D,E);
	}
	/**
	 * Efectua el càlcul de sumar el fill dret del fill esquerra
