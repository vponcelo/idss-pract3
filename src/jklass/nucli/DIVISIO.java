...
/**
 * Classe que representa l'operació  de divisió
 * És una subclasse de la classe OperacioBinaria
 * @author Laia Riera Guerra
 * @version v.4 05/05/2007
 */
public class DIVISIO extends OperacioBinaria{
	 ...
	 * E=3, número
	 */
	public DIVISIO(GestorMatriu m,Object fillD,Object fillE,int D,int E){
		super(m,fillD,fillE,D,E);
	}
	
	/**
	 * Efectua el càlcul de dividir el fill dret entre el fill esquerra
