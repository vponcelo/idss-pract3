...
public class DlgOpcPlot extends JDialog {
  ...
  public DlgOpcPlot(Frame frame, String title, boolean modal, Opcions opcions) {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.add(jPanEixY,       new GridBagConstraints(1, 0, 5, 3, 0.0, 0.0
    ...
    panel1.add(jPanEixX,                                   new GridBagConstraints(0, 0, 1, 3, 0.0, 0.0
  ...
  private void posarOpcions() {
    ...
    taula = opc.obtenirOpcionsEstad(Opcions.PLOT);
  ...
  void jBttnOK_actionPerformed(ActionEvent e) {
    ...
    opc.afegirOpcions(Opcions.PLOT, taula);
  ...
  void jBttnDefecte_actionPerformed(ActionEvent e) {
    opc.posarPerDefecte(Opcions.PLOT);
