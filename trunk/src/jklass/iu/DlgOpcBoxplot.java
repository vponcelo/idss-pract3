...
public class DlgOpcBoxplot extends JDialog {
  ...
  JRadioButton jRBResum = new JRadioButton();
  ...
  public DlgOpcBoxplot(Frame frame, String title, boolean modal, Opcions opcions) {
  ...
  private void jbInit() throws Exception {
    ...
    jRBResum.setHorizontalAlignment(SwingConstants.LEFT);
    jRBResum.setText("Resum en 5 números");
    ...
    jPanResum.setLayout(flowLayout1);
    ...
    jPanEixX.add(jPanMarq, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, -70, 0, 0), 0, 0));
    jPanMarq.add(jRBMarquesX, null);
    jPanMarq.add(jTFNumMarq, null);
    jPanEixX.add(jPanResum, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
          , GridBagConstraints.WEST, GridBagConstraints.BOTH,
          new Insets(0, -70, 0, 0), 0, 0));
    jPanResum.add(jRBResum, null);
  ...
  private void posarOpcions() {
    ...
    taula = opc.obtenirOpcionsEstad(Opcions.BOXPLOT);
    ...
    if ( ( (String) taula.get("gradua")).equals("marques")) {
