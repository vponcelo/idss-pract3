 ...
 */
   ...
   */
      ...
      //frPare.setSize(618, 615);//alejandro cambio tamaño
         ...
         titledBorder1 = new TitledBorder(new EtchedBorder(EtchedBorder.RAISED,Color.white,new Color(156, 156, 158)),"Classificació");
      //border1 = BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.white,1),BorderFactory.createEmptyBorder(4,4,4,4));
   ...
   String [] arractivas = new String [activias.size()];
      ...
      //alejandro 
        ...
        //  System.out.println( "ALEEE tengo las activas aca????"+  activas.get(p));
          ...
          System.out.println( "tengoactivas en array????martes2/9"+  arractivas[p]);
                  ...
                  if (opc.getCateg()=='\u0000' && (opc.getTipus()==OpcionsDis.EUCLI || opc.getTipus()==OpcionsDis.ABS || opc.getTipus()==OpcionsDis.MINKO || opc.getTipus()==OpcionsDis.MIXTA || opc.getTipus()==OpcionsDis.ICHINO || opc.getTipus()==OpcionsDis.RALAM)){
                     ...
                     //if (VEINS.equals(metode)) { :
                        if (radioMetodeVRE.isSelected()) {
                          ...
                          // if(clasificada = gestor.classificarMatriu2(/*metode, */criteri, opc, identificador, tipus, archivo1, archivo2, ficheroHis, ficheroDrm,activas/*, jCBInversionsControl.isSelected()*/)) {
                       ...
                       System.out.println("opc"+opc.getCateg() );
							...
							//	for (int i=0;i<3;i++){
								 ...
								 if(clasificada = gestor.classificarMatriu(/*metode, */criteri, opc, identificador, tipus, archivo1, archivo2, ficheroHis, ficheroDrm/*, jCBInversionsControl.isSelected()*/)) {
      ...
      //    ordreProps.add(i, propietats.obtenirPropietat(i).obtenirId());
        System.out.println( "tengo las activas en el arrayale????"+  arractivas[r]); 
							...
							/*	 if ( validas.size()>0){ 
                             ...
                             if (clasificada = null != gestor.avaluaBCIClassifica(bConeixement, criteri, identificador, opc, tipus, controlInversions, archivo1, archivo2, ficheroHis, ficheroDrm)) {
                                 frPare.actualitzarBarraEstat(" Classificació realitzada correctament. ", false);
                                 frPare.habilitarOpcionsMenu(true, true);
                              } 
                              else {
