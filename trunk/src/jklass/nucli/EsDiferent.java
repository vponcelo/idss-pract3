...
/**
 * Classe que representa una expressió booleana mínima, on l'operador relacional és el diferent
 * És una subclasse de la classe EBRelacional
...
public class EsDiferent extends EBRelacional {
	...
	/**
	 * Avalua una expressió booleana, el nucli de la qual és l'operador diferent
	 * <p>
	...
	/**
	 * Creadora d'EsDiferent, on posa com a variable el paràmetre
	 * d'entrada <code>vari</code>, com a valor a comparar el paràmetre
	 * d'entrada <code>oValor</code>, el nom de l'operació a null,crea la
	 * llista de fills buida i l'operació pare nul.la
	 * 
